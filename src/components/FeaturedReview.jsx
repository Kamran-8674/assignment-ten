...
const FeaturedReviews = () => {
  ...
  useEffect(() => {
    fetch("https://assignment-ten-server-gamma.vercel.app/featuredreviews")
      .then((res) => res.json())
  ...
  if (loading)
    return (
      <span className="loading flex justify-center mx-auto items-center loading-spinner loading-xl"></span>
    );
